...
export default function LandingPage() {
  ...
  <ul className="flex justify-between items-center px-4">
    ...
    <li>
      <ul className='flex space-x-8 text-lg font-bold text-skyblue'>
    ...
    <li>
      <Link href={'/'} className="border border-skyblue hover:bg-skyblue text-skyblue hover:text-white font-bold py-2 px-4 rounded">
        Login
      </Link>
    </li>
  </ul>
  ...
  <main className="grid grid-cols-1 md:grid-cols-2 px-2 gap-4">
    ...
    <Link className='text-white my-2 bg-skyblue hover:bg-cyan-900 p-2 rounded' href="/" >Start Chatting now</Link>
    </div>
